"""
Ablated molecular VAE inference engine for non-GRU variants with SMILES batching.

Handles embedding generation, large-scale batching, and flexible output formats.
...
from models.ablation.molecular_vae_ablation_remove_gru import MolecularVAE
