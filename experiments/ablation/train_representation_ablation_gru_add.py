#!/usr/bin/env python3
"""
Training entry point for the GRU-add ablation variant of the molecular VAE.
...
def main():
    ...
    config_path = 'config/ablation/config_ablation_add.yaml'
    ...
    output_dir = f'model_checkpoints/Molecular_VAE_Representation_ablation_add'
