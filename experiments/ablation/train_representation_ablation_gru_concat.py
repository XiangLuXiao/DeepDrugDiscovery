#!/usr/bin/env python3
"""
Training entry point for the GRU-concat ablation variant of the molecular VAE.

Copyright (c) 2025 Xianglu Xiao
Author: Xianglu Xiao
"""

from trainers.ablation.vae_trainer_remove_gru import VAETrainer
...
def main():
    ...
    config_path = 'config/ablation/config_ablation_concat.yaml'
    ...
    output_dir = f'model_checkpoints/Molecular_VAE_Representation_ablation_concat'
