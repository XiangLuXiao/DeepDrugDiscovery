"""
Ablation helper to generate embeddings with the GRU-concat variant of the VAE.

Copyright (c) 2025 Xianglu Xiao
Author: Xianglu Xiao
"""

from inference.ablation.vae_inference_ablation_remove_gru import MolecularVAEInference
import pandas as pd
import gc
...
def main():
    ...
    model_path = "model_checkpoints/Molecular_VAE_Representation_ablation_concat/best_model.pth"  # Update this path
    ...
    inference_engine.save_embeddings(
        cmp_embeddings, 
        "data/processed_data/cmp_embeddings_ablation_gru_concat.npz", 
    ...
    inference_engine.save_embeddings(
        ...
        "data/processed_data/reference_embeddings_ablation_gru_concat.npz", 
