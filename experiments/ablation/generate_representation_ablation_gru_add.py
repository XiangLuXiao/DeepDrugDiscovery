"""
Ablation helper to generate embeddings with the GRU-add variant of the VAE.
...
def main():
    ...
    model_path = "model_checkpoints/Molecular_VAE_Representation_ablation_add/best_model.pth"  # Update this path
    ...
    inference_engine.save_embeddings(
        cmp_embeddings, 
        "data/processed_data/cmp_embeddings_ablation_gru_add.npz", 
    ...
    inference_engine.save_embeddings(
        ...
        "data/processed_data/reference_embeddings_ablation_gru_add.npz", 
