#!/usr/bin/env python3
"""
Training entry point for the feature-ablated variant of the molecular VAE.

Copyright (c) 2025 Xianglu Xiao
Author: Xianglu Xiao
"""

from trainers.ablation.vae_trainer_remove_features import VAETrainer
...
def main():
    ...
    output_dir = f'model_checkpoints/Molecular_VAE_Representation_ablation_remove_features'
